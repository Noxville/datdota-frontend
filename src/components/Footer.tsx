      ...
      <div className={styles.inner}>
        <div className={styles.row}>
          <div className={styles.copyright}>
            <strong>datdota</strong> &copy; {year}
          </div>
          ...
          <div className={styles.credits}>
            ...
            <span className={styles.sep} />
            Parsing:{' '}
            <a href="https://github.com/skadistats/clarity" target="_blank" rel="noreferrer">
              clarity
            </a>{' '}
            &amp;{' '}
            <a href="https://github.com/ButterflyStats/butterfly" target="_blank" rel="noreferrer">
              butterfly
            </a>
          </div>
        </div>
